...
public class ThreadUtils implements Serializable {
	 ...
	 *            ip:端口,ip:端口,ip:端口
	 */
	public static synchronized ThreadUtils getInstance(String esClusterName, String esIp, int esPort) {
		if (instance == null) {
	...
	public static void main(String[] args) {
		ThreadUtils esUtils = getInstance("cif-new-elasticsearch-2-4-0", "10.10.56.138", 9300);

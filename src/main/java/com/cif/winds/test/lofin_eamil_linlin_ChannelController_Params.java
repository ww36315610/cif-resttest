...
public class lofin_eamil_linlin_ChannelController_Params {
...
//      private static final String filePath=filePathS + "linlin_[email]_result.txt";
	...
	public static void main(String[] args) throws Exception {
		RestfulDao rd = new RestfullDaoImp();
		lofin_eamil_linlin_ChannelController_Params ucp = new lofin_eamil_linlin_ChannelController_Params();
		ucp.controller0(rd);
	}
}

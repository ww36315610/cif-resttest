...
public class UAT_TagQueryController_FanShe implements Runnable {
...
//					"FUNUPLEND_002_1,FUNUPLEND_002_2,FUNUPLEND_002_3,FUNUPLEND_016_4,FUNUPLEND_016_5,FUNUPLEND_016_6,FUNUPLEND_017_4,FUNUPLEND_017_5,FUNUPLEND_017_6");
			map.put("tagNames",
					"FUNUPLEND_016_4,FUNUPLEND_016_5,FUNUPLEND_016_6");
...
//			 map.put("param", "130921198209272258");

//			 map.put("tagType", "asset_overview");
			// map.put("param",
			// "xyf7a7959df4c515636420dd80ba8ca9025a9ac421d69d392a8e2f8ae788449a9e20160926");
//			 map.put("param","372922198509086222");
//			 map.put("param","xyc3ded03f38bce9225f67a8d54abd8ca3f6307ee39d4a61b768b5a2377bd6f2ae20160926");
...
//			 map.put("param", "6");
			// assertId
//			map.put("tagType", "account_of_credit");
//			map.put("param", "6");
//			map.put("dueDate", "2013-10-10");

			// map.put("tagType", "MA_get_data");
			// map.put("tagType", "456");
			// map.put("tagType", "balance_of_account");
			 map.put("tagType", "wjtest");
			 map.put("idCardNum", "130921198209272258");
	...
	static UAT_TagQueryController_FanShe pc = new UAT_TagQueryController_FanShe();
